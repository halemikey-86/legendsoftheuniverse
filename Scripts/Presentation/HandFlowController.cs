...
namespace LegendsOfTheUniverse.Presentation
{
    ...
    public class HandFlowController : MonoBehaviour
    {
        ...
        IEnumerator BeginOpeningHand()
        {
            ...
            SetPickPromptVisible(true);

            if (legendaryPickView != null)
                yield return legendaryPickView.RunPickRoutine();

            SetPickPromptVisible(false);
            ...
            yield return handView.DealOpeningHandRoutine(GetDeckPosition());

            if (keepButton != null)
                keepButton.gameObject.SetActive(true);
        }

        void SetPickPromptVisible(bool visible)
        {
        ...
        IEnumerator AfterKeepSequence()
        {
            ...
            if (storeView != null)
                yield return storeView.DealStoreRoutine(GetDeckPosition());
        }
        ...
        void EnsurePickPrompt()
        {
            ...
            pickPromptText.text = "Choose your Legendary Icon";
        ...
        Button CreateIconButton(string name, float anchorX, Sprite icon)
        {
            ...
            buttonRect.anchorMin = new Vector2(anchorX, 0.06f);
            buttonRect.anchorMax = new Vector2(anchorX, 0.06f);
