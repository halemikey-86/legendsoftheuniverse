...
namespace LegendsOfTheUniverse.Presentation
{
    ...
    public class CardChoiceModal
    {
        ...
        public void EnsureBuilt(Transform canvasRoot, Camera camera)
        {
            ...
            acceptButton = CreateButton(root.transform, "AcceptButton", "Accept", AcceptColor, new Vector2(0.5f, 0.38f), OnAcceptClicked);
            declineButton = CreateButton(root.transform, "DeclineButton", "Decline", DeclineColor, new Vector2(0.5f, 0.14f), OnDeclineClicked);
